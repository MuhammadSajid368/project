...
const Sidebar = () => {
  ...
  const Menu = [
    ...
    { title: "Leave", spacing: true, icon: <BiExit />, link: "" },
    {
      title: "Leaves",
      icon: <FaLeaf />,
      submenu: true,
    ...
    { title: "Inbox", icon: <AiOutlineMail />, link: "/student/inbox" },
    { title: "Profile", spacing: true, icon: <BsPerson />, link: "/teacher/profile" },
    { title: "Settings", icon: <AiOutlineSetting />, link: "/dashboard/settings" },
  ];
