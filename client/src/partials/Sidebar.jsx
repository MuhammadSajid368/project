...
import { PiPasswordBold, PiStudentBold } from "react-icons/pi";
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              {/* Professor */}
              <SidebarLinkGroup
                activecondition={pathname.includes("Professor")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
              ...
              {/* courses Board */}
              <SidebarLinkGroup activecondition={pathname.includes("/admin/courses")}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
              ...
              <li 
                className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${
                  pathname.includes("update-password") && "bg-slate-900"
                }`}
              >
                <NavLink
                  end
                  to="/update-password-admin"
                  className={`block text-slate-200 truncate transition duration-150 ${
